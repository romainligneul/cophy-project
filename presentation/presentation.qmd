...
![](../_analyses/figures/refManagement.png){fig-align="center" width="80%"}
...
- Either visit `https://github.com/romainligneul/cophy-project`, dowload (Code tab near the green button) and unzip in the desired location.
...
4. type `python -m ipykernel install --user --name quarto-env`
